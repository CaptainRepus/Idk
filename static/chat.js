document.addEventListener("DOMContentLoaded", () => {
    ...
    const steps = [
        ...
        { type: "api", content: "Motivational quote" },
        {
            type: "image",
            content:
                '<img src="/static/images/team_photo.jpg" alt="Team Photo">',
        },
        {
            type: "level",
            content: `Your current level: ${userLevel}, XP to next level: 100.`,
        },
        ...
        try {
            ...
            if (data.message) {
                ...
                if (currentStep < steps.length - 1)
                    showNextButton(); // Show Next button until the last step
